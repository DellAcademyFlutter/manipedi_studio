...
class DbHelper {
  ...
  static const SCRIPT_CREATE_TABLE_SCHEDULE_SQL =
      "CREATE TABLE IF NOT EXISTS schedule (id INTEGER NOT NULL, idCustomer INTEGER NOT NULL, date TEXT NOT NULL, "
      "time TEXT NOT NULL, PRIMARY KEY(id AUTOINCREMENT), FOREIGN KEY(idCustomer) REFERENCES customer(id))";
